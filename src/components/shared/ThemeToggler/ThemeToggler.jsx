...
function ThemeToggler() {
  ...
  return (
    <div className="flex items-center h-8 gap-2 px-1 py-2 border border-blueLight dark:border-navyDark relative rounded-full max-w-max">
      <button
      ...
      <div
        className={`w-6 h-6 bg-primaryColor absolute left-1 rounded-full duration-300 ${
