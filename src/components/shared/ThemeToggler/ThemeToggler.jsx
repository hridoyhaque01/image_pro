...
function ThemeToggler() {
  ...
  return (
    <div className="">
      <input type="checkbox" id="themeToggler" className="absolute opacity-0" />
      <label
        htmlFor="themeToggler"
        className="flex items-center justify-between w-16 h-8 bg-white dark:bg-blackHigh ring-1 ring-blueLight
        dark:border-navyDark rounded-full p-1 px-2 relative"
      >
        <svg
          width="16"
          height="16"
          ...
          className={`text-xl relative z-20 cursor-pointer `}
        ...
        >
          <path
            ...
            className={!isDarkMode ? "fill-white" : "fill-navyLight"}
          />
        </svg>
        ...
        <div
          className={`absolute top-[2px] left-1 h-7 w-7 bg-primaryColor rounded-full duration-300  ${
